 ...
 * 
 */
@WebServiceClient(name = "CommonService", targetNamespace = "www.WebService.hb110.landfun.cn", wsdlLocation = "http://192.168.124.31:8080/services/CommonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COMMONSERVICE_QNAME = new QName("www.WebService.hb110.landfun.cn", "CommonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.124.31:8080/services/CommonService?wsdl");
    ...
    public CommonService getCommonServiceImplPort() {
        return super.getPort(new QName("www.WebService.hb110.landfun.cn", "CommonServiceImplPort"), CommonService.class);
    }
    ...
    public CommonService getCommonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("www.WebService.hb110.landfun.cn", "CommonServiceImplPort"), CommonService.class, features);
    }
